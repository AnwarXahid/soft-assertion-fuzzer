...
class TripletLoss(nn.Module):
    ...
    def forward(self, anchor, positive, negative, size_average=True):
        ...
        if self.swap:
            ...
            distance_negative[distance_positive_negative < distance_negative] = distance_positive_negative[
                distance_positive_negative < distance_negative]

        ## Inserted code

        # Also, you can break at pow at first line of this method
