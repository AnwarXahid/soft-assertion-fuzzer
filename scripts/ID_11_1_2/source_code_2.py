...
"""
Source: https://github.com/declare-lab/MM-Align/blob/main/src/modules/OT_solver.py
"""

class OTSolver(nn.Module):
    def __init__(self, lam=0.2, maxIter=10, eps=1e-7, win_size=2):  # method = "cosine"
        super().__init__()
        self.lam = lam
...
#     # trans, cost = solver.compute_optimal_transport(dist)
